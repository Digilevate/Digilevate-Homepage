...
const Datenschutz: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Datenschutzerklärung digilevate Webagentur Zürich | Schutz Ihrer Daten</title>
        <meta name="description" content="Datenschutzerklärung der digilevate Webagentur Zürich. Informationen zur Erhebung, Verarbeitung und Schutz Ihrer personenbezogenen Daten auf unserer Webseite." />
      </Helmet>
      <div className="bg-gradient-to-br from-[#0a2a38] via-[#1d4a5f] to-[#0a2a38] text-white p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-2xl md:text-4xl font-bold mb-8 gradient-text">Datenschutzerklärung</h1>
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed">
            ...
            <a href="/" className="text-[#2d9bf0] hover:underline mt-8 inline-block">&larr; Zurück zur Startseite</a>
          </div>
        </div>
      </div>
    </>
