...
const Impressum: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Impressum digilevate Webagentur Zürich | Kontakt & Rechtliche Hinweise</title>
        <meta name="description" content="Impressum der digilevate Webagentur Zürich. Kontaktinformationen, Inhaber (Loris Imbrogno, Alessio Fano) und rechtliche Hinweise für Webdesign-Projekte." />
      </Helmet>
      <div className="bg-gradient-to-br from-[#0a2a38] via-[#1d4a5f] to-[#0a2a38] text-white p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-2xl md:text-4xl font-bold mb-8 gradient-text">Impressum</h1>
