                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
                    <div className="space-y-8">
                        ...
                        <ul className="space-y-4">
                           <ListItem text="15+ years combined experience in web development and IT" />
    ...
    <div className="glass-effect rounded-2xl p-8 hover-glow transition-all duration-500">
        <div className="space-y-8">
            <FounderProfile
                ...
                jobTitle="GOOGLE - Software Engineering Apprentice, 3rd Year"
            ...
            <FounderProfile
                ...
                jobTitle="SWISSCOM - Software Engineering Apprentice, 3rd Year"
